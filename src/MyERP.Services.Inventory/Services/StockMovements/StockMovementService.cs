    ...
    public class StockMovementService : IStockMovementService
    {
        ...
        public async Task<StockMovementResponseDto> RecordMovementAsync(RecordStockMovementDto dto, Guid? userId = null)
        {
            ...
            var movement = new StockMovement
            {
                ...
                FromWarehouseId = (dto.MovementType.ToUpper() == MovementType.OUT || dto.MovementType.ToUpper() == MovementType.ADJUST_OUT) ? location.WarehouseId : null,
                FromLocationId = (dto.MovementType.ToUpper() == MovementType.OUT || dto.MovementType.ToUpper() == MovementType.ADJUST_OUT) ? dto.StorageLocationId : null,
